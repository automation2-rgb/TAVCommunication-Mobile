...
export function isFailedMessageStatus(status: string | null | undefined): boolean {
...
export function pendingPreviewToComposerFile(preview: PendingAttachmentPreview): ComposerFile {
  return {
    uri: preview.uri,
    name: preview.filename?.trim() || 'attachment',
